...
public class Queen extends Piece {
    ...
    public Queen(ChessPiece piece, boolean isWhite, int row, int col, Game game) {
    ...
    public void setImage() {
        ...
        try {
            ...
            if (isWhite) {
                File file = new File(
                        "./Images/piece_0_1.png");
                this.image = ImageIO.read(file);
            } else {
                File file = new File(
                        "./Images/piece_1_1.png");
                this.image = ImageIO.read(file);
            }
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public long calculateRayMoves(long position, long whitePieces, long blackPieces, int direction) {
        ...
        long fileBoundaryMask = (direction == 7 || direction == -9 || direction == -1) ? ~FILE_H : ~FILE_A;
